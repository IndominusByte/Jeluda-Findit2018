...
<form method="POST" action="{{url("/jelajah/{$posting->id}")}}" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control {{ $errors->has('deskripsi_singkat') ? ' is-invalid' : ''  }}" onkeyup="countChar(this)" name="deskripsi_singkat" id="exampleFormControlTextarea1" rows="5">{{$posting->deskripsi}}</textarea>
...
@endif                                                      
  ...
  <div class="form-group">
    ...
    <textarea id="area1" rows="20" class="form-control {{ $errors->has('deskripsi_makanan_tradisional') ? ' is-invalid' : '' }}" name="deskripsi_makanan_tradisional" id="exampleFormControlTextarea1" >{{$makanan->desc}}</textarea>
...
@endif                                                        
  ...
  <div class="form-group">
    ...
    <textarea id="area2" class="form-control {{ $errors->has('deskripsi_rumah_adat_tradisional') ? ' is-invalid' : ''}}" name="deskripsi_rumah_adat_tradisional" id="exampleFormControlTextarea1" rows="20">{{$rumah->desc}}</textarea>
...
@endif                                                                           
  ...
  <div class="form-group">
    ...
    <textarea id="area3" class="form-control {{ $errors->has('deskripsi_tarian_tradisional') ? ' is-invalid' : '' }}" name="deskripsi_tarian_tradisional" id="exampleFormControlTextarea1" rows="20">{{$tarian->desc}}</textarea>
...
@endif                                                                   
  ...
  <div class="form-group">
    ...
    <textarea id="area4" class="form-control {{ $errors->has('deskripsi_senjata_tradisional') ? ' is-invalid' : ''   }}" name="deskripsi_senjata_tradisional" id="exampleFormControlTextarea1" rows="20">{{$senjata->desc}}</textarea>
...
@endif                                                     
  ...
  <div class="form-group">
    ...
    <textarea id="area5" class="form-control {{ $errors->has('deskripsi_alat_musik_tradisional') ? ' is-invalid' : '' }}" name="deskripsi_alat_musik_tradisional" id="exampleFormControlTextarea1" rows="20">{{$musik->desc}}</textarea>
...
@endif                                                                           
  ...
  <div class="form-group">
    ...
    <textarea id="area6" rows="20" class="form-control {{ $errors->has('deskripsi_pakaian_adat') ? ' is-invalid' : ''}}" name="deskripsi_pakaian_adat" id="exampleFormControlTextarea1" rows="10">{{$pakaian->desc}}</textarea>
...
@endif                                                                 
  ...
  <div class="form-group">
    ...
    <textarea id="area7" rows="20" class="form-control {{ $errors->has('deskripsi_bahasa_daerah') ? ' is-invalid' : ''}}" name="deskripsi_bahasa_daerah" id="exampleFormControlTextarea1" rows="10">{{$bahasa->desc}}</textarea>
...
<script>
 ...
 <script type="text/javascript">
       bkLib.onDomLoaded(function() {
        ...
        new nicEditor({maxHeight : 250}).panelInstance('area2');
        new nicEditor({maxHeight : 250}).panelInstance('area3');
        new nicEditor({maxHeight : 250}).panelInstance('area4');
